...
# Note: Problematic pods moved to chaos scenarios for on-demand deployment
echo -e "${GREEN}✅ All healthy applications deployed!${NC}"
echo -e "${YELLOW}💡 Use ./chaos-scenarios.sh to simulate failures on-demand${NC}"
echo ""
